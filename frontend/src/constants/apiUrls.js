...
export const USER_PREFERENCES_URL = `${API_BASE}/api/user/preferences`;
export const USER_FAVORITES_URL = `${API_BASE}/api/user/favorites`;
export const AI_SUMMARIZE_URL = `${API_BASE}/api/ai/summarize`;
